...
class vlastnikarchiv
{
    ...
    public function vypis($sql,$co,$dotaz_final)
    {
	    ...
	    <td class=\"vlastnici-td-black\" colspan=\"6\" align=\"right\" width=\"\" >";
                ...
                if (!( $vlastnici_update_povolen =="true") ) { echo "<span style=\"\" >  upravit  </span> \n"; 
                }
		 ...
		 tel: ".$data["telefon"]." </td>
		    ...
		    <a href=pohoda_sql/phd_list_fa.php?id_vlastnika=".$data["id_cloveka"]."\" > výpis plateb - (od 3/2012)</a>".
                ...
                */
                ...
                if (( $data["fakturacni"] > 0 ) ) { echo "<a href=\"vlastnici2-erase-f.php?id=".$data["fakturacni"]."\" > smazání </a>"; 
                }
                else 
                { echo " smazání "; 
                }
                ...
                if (( $data["fakturacni"] > 0 ) ) { echo "<a href=\"vlastnici2-change-fakt.php?id=".$data["fakturacni"]."\" > úprava </a>"; 
                }
                else
                { echo " úprava "; 
                }
                ...
                if ($data["k_platbe"] == "250" ) { echo "<input type=\"hidden\" name=\"tarif\" value=\"1\" >"; 
                }
                elseif($data["k_platbe"] == "420" ) { echo "<input type=\"hidden\" name=\"tarif\" value=\"2\" >"; 
                }
                else

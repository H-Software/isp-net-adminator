...
CREATE TABLE public.vlastnici (
    ...
    archiv integer,
    ulice character(100) COLLATE pg_catalog."default",
    mesto character(100) COLLATE pg_catalog."default",
    vs character(50) COLLATE pg_catalog."default",
    icq character(50) COLLATE pg_catalog."default",
    mail character(50) COLLATE pg_catalog."default",
    telefon character(50) COLLATE pg_catalog."default",
    fakturacni_skupina_id integer,
    nick character(150) COLLATE pg_catalog."default",
    psc character(50) COLLATE pg_catalog."default",
    firma integer,
    k_platbe integer,
    ucetni_index integer,
    poznamka text COLLATE pg_catalog."default",
    fakturacni integer,
    pridano date,
    billing_suspend_start date,
    billing_suspend_stop date,
    billing_freq integer DEFAULT 0,
    jmeno character(100) COLLATE pg_catalog."default",
    prijmeni character(100) COLLATE pg_catalog."default",
    splatnost integer,
    trvani_do date,
    ...
    billing_suspend_reason character(100) COLLATE pg_catalog."default"
);

...
function cbExpandFolder(xml) {
	...
	for (i=0;i<folders.length;i++) {
		...
		if (folders[i].getElementsByTagName('name')[0]) {
			var name = unescape(folders[i].getElementsByTagName('name')[0].firstChild.data.trim());
	...
	for (i=0;i<files.length;i++) {
		...
		if (files[i].getElementsByTagName('name')[0]) {
			var name = unescape(files[i].getElementsByTagName('name')[0].firstChild.data.trim());

...
echo "<table border=\"0\" width=\"1000px\">
	...
	<tr>
	    <td><div style=\"padding-left: 20px;\" class=\"label-font\"><label>Váš technik</label></div></td>
	    <td><input type=\"text\" name=\"vas_technik\" value=\"".$vas_technik."\"></td>
	    <td width=\"20px\">&nbsp;</td>
	    <td width=\"20%\" class=\"label-font\">Telefon:</td>
	    <td width=\"20%\"><input type=\"text\" name=\"vas_technik_tel\" value=\"".$vas_technik_tel."\" ></td>
	</tr>

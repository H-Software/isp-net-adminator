...
<title>Adminator 2 - automatika</title>
...
<? include ("category.php"); ?> 
  ...
  <td>
  <?
  echo "<span style=\"background-color: silver; \">Automatika - Kontrola splatnosti 
  faktury vs. vlastník </span>";
  echo "<br><br>";
  ...
  if ( !($send) )
  {
  $vysledek=mysql_query("select * from automatika where vec LIKE 'kontrola_fn_vlastnik' " );
  $radku=mysql_num_rows($vysledek);
    ...
    echo "<td><b> čas, kdy se má odpočítávat (hodina)</b> : ".$cas_hodina."</td>";
    ...
    echo "<td>vec: kontrola_fn_vlastnik</td> \n";
    
    echo "<td>";
    
    echo "<input type=\"hidden\" name=\"vec\" value=\"kontrola_fn_vlastnik\" >";

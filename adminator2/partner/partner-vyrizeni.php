...
<?php
   ...
   else
   {
	...
	$id = intval($_GET["id"]);
        ...
        $uprava=mysql_query("UPDATE partner_klienti SET akceptovano='1', akceptovano_kym='".$conn_mysql->real_escape_string(\Cartalyst\Sentinel\Native\Facades\Sentinel::getUser()->email)."', ".

 ...
 <tr><td colspan="{$pocet_bunek}" ><br></tr>
 ...
 <form action="{$action}" method="GET" name="form4" >
  ...
  <tr><td colspan="{$pocet_bunek}" style="border-bottom: 1px solid black;" ><br></tr>
  ...
  <tr><td colspan="{$pocet_bunek}" style="border-bottom: 1px solid black;" ><b>Text</b></td>
  
  <td colspan="{$pocet_bunek}" ><br></tr>

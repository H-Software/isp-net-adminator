  ...
  <?
   ...
   $nove_heslo=$_POST["nove_heslo"];
	...
	if( isset($update_id2) )
	{
		...
		$add=$conn_mysql->query("UPDATE partner_login SET password='$nove_heslo_crypt' WHERE id='$update_id2' ");
    ...
    elseif( isset($odeslat) )
    {
		...
		$add=$conn_mysql->query("INSERT INTO partner_login (login, password) VALUES ('$jmeno','$heslo_crypt') ");
    ...
    else
    {
		...
		$dotaz=$conn_mysql->query("SELECT * FROM partner_login ORDER BY id");

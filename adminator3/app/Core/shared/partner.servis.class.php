...
class partner_servis
{
    ...
    function show_insert_form()
    {
        ...
        echo "      </div>
                ...
                echo "<option value=\"1\" "; if($this->prio == 1) { echo "selected";
                } echo " >Vysoká</option>";
                echo "<option value=\"2\" "; if($this->prio == 2 or !isset($this->prio)) { echo "selected";
                } echo " >Normal</option>";
                echo "<option value=\"3\" "; if($this->prio == 3) { echo "selected";
                } echo " >Nízká</option>";
    ...
    function save_form()
    {
        ...
        if(isset($this->klient_id) ) { $this->jmeno_klienta .= ",  V:".$this->klient_id; 
        }
        ...
        if(isset($user) ) { $user_plaint= $_SESSION["user_plaint"]; 
        }
        else
             ...
             echo "<tr><td colspan=\"8\" >
                    ...
                    <span style=\"padding-left: 20px; \">
                        ...
                        <option value=\"0\" "; if ($filtr_akceptovano == 0 or !isset($filtr_akceptovano) ) { echo " selected "; 
                         ...
                         <option value=\"1\" "; if ($filtr_akceptovano == 1 ) { echo " selected "; 
} echo ">Ano</option>
                         <option value=\"2\" "; if ($filtr_akceptovano == 2 ) { echo " selected "; 
} echo ">Ne</option>
                        </select>
                    </span>
                    ...
                    <span style=\"padding-left: 20px; \">
                        <select name=\"filtr_prio\" size=\"1\">
                         <option value=\"0\" "; if ($filtr_prio == 0 or !isset($filtr_prio)) { echo " selected "; 
                                ...
                                echo " class=\"select-nevybrano\">Nevybráno</option>
                         <option value=\"1\" "; if ($filtr_prio == 1 ) { echo " selected "; 
} echo " >Vysoká</option>
                         <option value=\"2\" "; if ($filtr_prio == 2 ) { echo " selected "; 
} echo " >Normální</option>
                         <option value=\"3\" "; if ($filtr_prio == 3 ) { echo " selected "; 
} echo " >Nízká</option>

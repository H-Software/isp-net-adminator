    ...
    public function vypis_cisla($mod)
    {
     ...
     <tr><td colspan=\"".$pocet_sloupcu."\"><br></td></tr>";
        ...
        while ($data = mysql_fetch_array($this->dotaz_rs)) {
            ...
            if ($mod == 2) {
                echo "<span style=\"color: grey;\">id čísla: </span>";
            }
            echo $data["id_cisla"]."</td>";

            echo "<td class=\"voip-vypis-radek\">";
            if ($mod == 2) {
                echo "<span style=\"color: grey;\">tel. číslo: </span>";
            }
            echo $data["cislo"]."</td>";

            echo "<td class=\"voip-vypis-radek\">";
            if ($mod == 2) {
                echo "<span style=\"color: grey;\">id vlastníka: </span>";
            }
            ...
            echo "<td class=\"voip-vypis-radek\">";
            if ($mod == 2) {
                echo "<span style=\"color: grey;\">typ systému: </span>";
            }

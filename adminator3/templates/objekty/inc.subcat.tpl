<div class="base-subcat-main" >
    ...
    ,
    <span style="padding-left: 5px; padding-right: 10px; "><a class="cat2" href="/objekty-lite.php">omezený režim (a2)</a> )</span>
    ...
    <a class="cat2" href="objekty-stb.php">set-top-boxy</a></span>

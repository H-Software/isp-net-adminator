...
class voip
{
    ...
    public function zjisteni_vlastnika($id_vlastnika)
    {
        ...
        if ($archiv_vlastnik == 1) { echo "<a href=\"/adminator2/vlastnici-archiv.php?find_id=".$id_vlastnika."\" "; 
        }
        elseif ($firma_vlastnik == 1 ) { echo "<a href=\"/adminator2/vlastnici2.php?find_id=".$id_vlastnika."\" "; 
        }
        else

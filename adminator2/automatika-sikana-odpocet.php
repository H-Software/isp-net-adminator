...
<? include ("category.php"); ?> 
  ...
  <td>
  <?
  echo "<span style=\"background-color: silver; \">Automatika - šikana </span>";
  echo "<br><br>";
  ...
  $radku=mysql_num_rows($vysledek);
    ...
    echo "<td>vec: sikana_odpocet</td> \n";
    
    echo "<td>";
    
    echo "<input type=\"hidden\" name=\"vec\" value=\"sikana_odpocet\" >";
